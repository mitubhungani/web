...
// import { createProduct, deleteProduct, getProduct } from "../../slice/ProductSlice";
...
//     const currentUser = auth.currentUser;
//     if (currentUser) {
//       setUserUID(currentUser.uid); // Store the logged-in user's UID
//     }
//     dispatch(getProduct());
//   }, [dispatch]);
...
//       setExcelData(sheet); // Store data in state
//     };
...
//       {excelData.length > 0 && (
//         <div className="mt-8">
//           <h3 className="text-lg font-semibold mb-4">Excel Data:</h3>
//           <table className="min-w-full table-auto">
//             <thead>
//               <tr>
//                 {Object.keys(excelData[0]).map((key) => (
//                   <th key={key} className="px-4 py-2 bg-gray-200">{key}</th>
//                 ))}
//               </tr>
//             </thead>
//             <tbody>
...
//               <img src={ele.image} alt={ele.title} className="w-full h-40 object-cover mt-2" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {image && (
            <div className="mt-4">
              ...
              <img src={image} alt="Preview" className="w-40 h-40 object-cover mt-2 rounded-md" />
            </div>
          )}
